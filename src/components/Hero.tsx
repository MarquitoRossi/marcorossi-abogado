    ...
    >
      ...
      <div className="relative z-10 section-container text-center py-32">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main Headline */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-8 opacity-0 animate-fade-in-up animation-delay-200">
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-primary-foreground/70 max-w-2xl mx-auto mb-12 opacity-0 animate-fade-in animation-delay-400">
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-0 animate-fade-in animation-delay-700">
          <button
            onClick={() => scrollToSection('#que-hago')}
